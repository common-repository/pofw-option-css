<?php
/**
 * Plugin Name: POFW Option CSS 
 * Description: Allows to add a custom CSS class to the product options of the "Product Options for WooCommerce" plugin.
 * Version: 1.0.0
 * Author: Pektsekye
...
final class Pektsekye_OptionCss {
  ...
  private function init_hooks(){ 
    new Pektsekye_OptionCss_Model_Observer();           
  }    
  ...
  private function init_controllers(){
      ...
      new Pektsekye_OptionCss_Controller_Product();    	
      ...
      if ((isset($_GET['post']) && isset($_GET['action']) && $_GET['action'] == 'edit') || ('post-new.php' == $pagenow && isset($_GET['post_type']) && $_GET['post_type'] == 'product')){         
        ...
        new Pektsekye_OptionCss_Controller_Adminhtml_Product();                    
      }                
    }     	  
  }  
...
function Pektsekye_OCSS(){
	return Pektsekye_OptionCss::instance();
}

include_once('Setup/Install.php');  
register_activation_hook(__FILE__, array('Pektsekye_OptionCss_Setup_Install', 'install'));
